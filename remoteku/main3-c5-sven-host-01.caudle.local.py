...
def build_notebooks(self):
    main = Tk()
    maintab = ttk.Notebook(main)
    tab1 = ttk.Frame(maintab)
    maintab.add(tab1, text="CC-L")
    maintab.pack(expand=1, fill="both")
    tab2 = ttk.Frame(maintab)
    maintab.add(tab2, text="CC-R")
    maintab.pack(expand=1, fill="both")
    tab3 = ttk.Frame(maintab)
    maintab.add(tab3, text="CC-*")
    maintab.pack(expand=1, fill="both")
    tab4 = ttk.Frame(maintab)
    maintab.add(tab4, text="lr-TV")
    maintab.pack(expand=1, fill="both")
    label1 = Label(tab1, text="HELLO WORLD").pack()
